...
void HAL_TIM_IC_CaptureCallback(TIM_HandleTypeDef *htim) {
    if (htim->Instance == TIM17) {
        ...
        if (htim->Channel == HAL_TIM_ACTIVE_CHANNEL_1) {
            ...
            SpeedSensor_CaptureCallback(&g_speed_sensors[1], capture);
        }
...
//            SpeedSensor_CaptureCallback(&g_speed_sensors[2], capture);
//        }
//        else if (htim->Channel == HAL_TIM_ACTIVE_CHANNEL_4) {
//            uint32_t capture = HAL_TIM_ReadCapturedValue(htim, TIM_CHANNEL_4);
//            SpeedSensor_CaptureCallback(&g_speed_sensors[3], capture);
//        }
    }
}
/* USER CODE END 1 */
